...
(function() {
  var $, ItemView, ItemsFilterView, ItemsView, addwa, addwoa, addwoata, cdict, enval, h, prefix, remIndiv, remMulti, root, w,
    _this = this,
  ...
  remIndiv = function(pill) {
    ...
    if (!this.tagajaxsubmit) {
      console.log("OLDNEWTAGS1", this.tagajaxsubmit, this.newtags);
      this.remove_from_tags(tag);
      return console.log("NEWNEWTAGS", this.newtags);
    } else {
      return console.log("INDIVREM2", this.tagajaxsubmit);
    }
  };
  ...
  ItemView = (function(_super) {
    ...
    ItemView.prototype.update_tags = function(newtag) {
      console.log("" + this.item.basic.name + " >>>", newtag);
    ...
    ItemView.prototype.submitNote = function() {
      var cback, eback, item, itemname, loc, notetext,
        _this = this;
  ...
  remMulti = function(pill) {
    ...
    if (!this.tagajaxsubmit) {
      console.log("MULTIREM1", this.tagajaxsubmit, pill);
      _ref = this.items;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        i = _ref[_i];
        fqin = i.basic.fqin;
        console.log("YS", this.itemviews[fqin].tagsobject);
        this.itemviews[fqin].tagsobject.removeTag(this.itemviews[fqin].$("[data-tag-id='" + tag + "']"));
        _results.push(console.log("HERE"));
      }
      return _results;
    } else {
      return console.log("MULTIREM2", this.tagajaxsubmit);
    }
  };
  ...
  ItemsView = (function(_super) {
    ...
    ItemsView.prototype.update_posts = function(postables) {
      ...
      return console.log("NEWPOSTS", this.newposts);
    };
    ...
    ItemsView.prototype.render = function() {
      ...
      cback = function(data) {
        ...
        console.log("MULTILIBRARY", _this.$('.multilibrary'));
