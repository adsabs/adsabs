...
(function() {
  var $, ItemView, ItemsFilterView, ItemsView, addwa, addwoa, addwoata, cdict, didupost, enval, h, parse_fqin, prefix, remIndiv, remMulti, root, time_format_iv, w, _ref, _ref1, _ref2,
  ...
  ItemView = (function(_super) {
    ...
    ItemView.prototype.initialize = function(options) {
      ...
      this.tagsfunc = (_ref1 = options.tagfunc) != null ? _ref1 : function() {};
      this.hv = void 0;
      this.newtags = [];
      this.newnotes = [];
      this.newposts = [];
    ...
    ItemView.prototype.remove_notes = function(newnotetext) {
      var ele, newernotes, _i, _len, _ref1;
      newernotes = [];
      _ref1 = this.newnotes;
    ...
    ItemView.prototype.render = function() {
      var additional, additionalpostings, adslocation, content, deleter, fqin, htmlstring, jslist, p, tagdict, thepostings, thetags, url, _ref1;
      this.$el.empty();
      adslocation = GlobalVariables.ADS_ABSTRACT_BASE_URL;
      url = adslocation + ("" + this.item.basic.name);
      if (((_ref1 = this.pview) !== 'udg' && _ref1 !== 'pub' && _ref1 !== 'none') && didupost(this.postings, this.memberable, this.pview)) {
    ...
    ItemView.prototype.update_note_ajax = function(data) {
      var fqin, notes, stags, _ref1;
      fqin = this.item.basic.fqin;
      _ref1 = get_taggings(data), stags = _ref1[0], notes = _ref1[1];
  ...
  remMulti = function(pill) {
    var fqin, i, tag, _i, _len, _ref1, _results;
    tag = $(pill).attr('data-tag-id');
    if (!this.tagajaxsubmit) {
      _ref1 = this.items;
      _results = [];
  ...
  ItemsView = (function(_super) {
    ...
    function ItemsView() {
      ...
      _ref1 = ItemsView.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
    ...
    ItemsView.prototype.update_postings_taggings = function() {
      ...
      return $.get(prefix + ("/items/taggingsandpostings?" + itemsq), function(data) {
        var e, fqin, k, v, _i, _len, _ref2, _ref3, _ref4, _results;
        _ref2 = get_taggings(data), _this.stags = _ref2[0], _this.notes = _ref2[1];
        _ref3 = data.postings;
        for (k in _ref3) {
    ...
    ItemsView.prototype.update_posts = function(postables) {
      var fqin, i, p, _i, _j, _len, _len1, _ref2;
    ...
    ItemsView.prototype.render = function() {
      var $ctrls, $lister, cback, counter, eback, fqin, i, ins, v, _i, _len, _ref2,
        _this = this;
      $lister = this.$('.items');
      $ctrls = this.$('.ctrls');
      this.itemviews = {};
    ...
    ItemsView.prototype.collectTags = function() {
      var e, fqin, i, iview, ntags, tags, _i, _len, _ref2;
      tags = {};
      _ref2 = this.items;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        i = _ref2[_i];
    ...
    ItemsView.prototype.collectNotes = function() {
      var e, fqin, i, iview, notes, ntags, _i, _len, _ref2;
      notes = {};
      _ref2 = this.items;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        i = _ref2[_i];
    ...
    ItemsView.prototype.submitTags = function() {
      var cback, e, eback, fqin, i, loc, tags, tagstring, ts, _i, _len, _ref2,
        _this = this;
      ts = {};
  ...
  ItemsFilterView = (function(_super) {
    ...
    function ItemsFilterView() {
      this.render = __bind(this.render, this);
      _ref2 = ItemsFilterView.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
    ...
    ItemsFilterView.prototype.render = function() {
      var counter, fqin, i, ins, v, _i, _len, _ref3;
      this.itemviews = {};
      counter = 1;
      _ref3 = this.items;
