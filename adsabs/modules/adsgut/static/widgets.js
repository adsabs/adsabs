...
(function() {
  var $, $one_col_table, $table_from_dict, $table_from_dict_many, HideableView, HoverHelpDecoratorView, addchoices, decohelp, dropdown_submit, dropdown_submit_with_cb, editable_text, h, info_layout, inline_list, link, multiselect, one_col_table, one_col_table_partial, one_submit, one_submit_with_cb, parse_fqin, postalall_form, postalnote_form, postcontrol, regular_list, root, single_button, single_button_label, table_from_dict, table_from_dict_many, table_from_dict_partial, table_from_dict_partial_many, two_submit, zero_submit, _ref, _ref1,
  ...
  zero_submit = h.renderable(function(ltext, btext) {
    h.label(ltext);
    return h.form(".form-inline", function() {
      h.raw("&nbsp;&nbsp;&nbsp;");
      return h.button(".btn.btn-primary.sub", {
  ...
  HideableView = (function(_super) {
    ...
    function HideableView() {
      ...
      _ref = HideableView.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  HoverHelpDecoratorView = (function(_super) {
    ...
    function HoverHelpDecoratorView() {
      this.render = __bind(this.render, this);
      _ref1 = HoverHelpDecoratorView.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
