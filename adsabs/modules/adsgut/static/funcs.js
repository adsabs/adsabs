...
(function() {
  var $, AddGroup, CreatePostable, InviteUser, br, dd, dl, dt, email_split, format_item, format_notes_for_item, format_postings_for_item, format_tags, format_tags_for_item, get_groups, get_taggings, get_tags, group_info_template, group_itemsinfo_template, li, library_info_template, library_itemsinfo_template, monthNamesShort, parse_fortype, parse_fqin, postable_info, postable_info_layout, postable_info_layout2, postable_inviteds, postable_inviteds_template, prefix, raw, renderable, root, rwmap, short_authors, strong, this_postable, time_format, ul, w,
  ...
  this_postable = function(pview, pval) {
    var pble;
    if (pview !== 'udg' && pview !== 'none' && pview === pval) {
      return pble = "<i class='icon-cog'></i>&nbsp;&nbsp;";
    } else {
      pble = '';
      return pble;
    }
  ...
  format_notes_for_item = function(fqin, notes, currentuser, pview) {
    ...
    t3list = (function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        t = _ref[_i];
        _results.push("<tr><td style='white-space: nowrap;'>" + (time_format(t[1])) + "</td><td style='text-align: right;'>" + (t[2] === currentuser ? 'me' : email_split(t[2])) + "&nbsp;&nbsp;</td><td>" + (t[3] === '1' ? lock : '') + t[0] + "</td></tr>");
      }
      return _results;
    })();
    if (t3list.length > 0) {
        ...
        notes[k] = (function() {
          ...
          for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
            ...
            if (e.posting.tagtype === "ads/tagtype:note") {
              _results.push([e.posting.tagdescription, e.posting.whenposted, e.posting.postedby, e.posting.tagmode, e.pinpostables]);
            }
          }
          return _results;
        })();
