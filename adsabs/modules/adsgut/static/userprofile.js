...
(function() {
  var $, Postable, PostableList, PostableListView, PostableView, h, layout_userprofile, lmap, make_postable_link, make_postable_link_secondary, parse_fqin, parse_userinfo, prefix, render_postable, root, rwmap, w, _ref, _ref1, _ref2, _ref3,
  ...
  parse_userinfo = function(data) {
    var e, ele, groupsin, groupsinvitedto, groupsowned, librariesin, librariesinvitedto, librariesowned, p, pinfqin, postablesin, postablesinvitedto, postablesowned, powfqin, priv, publ, userdict, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref2, _ref3;
  ...
  make_postable_link_secondary = h.renderable(function(fqpn, libmode, ownermode) {
    if (libmode == null) {
      libmode = false;
    }
    if (ownermode == null) {
  ...
  Postable = (function(_super) {
    ...
    function Postable() {
      _ref = Postable.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  PostableView = (function(_super) {
    ...
    function PostableView() {
      ...
      _ref1 = PostableView.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  PostableList = (function(_super) {
    ...
    function PostableList() {
      _ref2 = PostableList.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  PostableListView = (function(_super) {
    ...
    function PostableListView() {
      this.render = __bind(this.render, this);
      _ref3 = PostableListView.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
